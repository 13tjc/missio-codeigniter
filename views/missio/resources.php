...
<script type="text/javascript">
    missio.FILTER_LIST = <?php echo json_encode($data['filter_list'], false) ?>;
</script>
...
<!-- <section class="banner_sec resources_banner">
    <div class="wrapper">
        <div class="left_sec">
            <p><span>POWERED BY</span> The Pontifical Mission Societies. <a href="#">Learn more.</a></p>
            <h3>Resources</h3>
        </div>
...
<section class="body_container">
    <div class="resource_sec">
        <div class="wrapper">
            <div class="left_sidebar">
                <h2>Filter By:</h2>
                <ul class="responsive-accordion resource-filters">
                    <?php foreach ($data['filters'] as $group => $filters): ?>
                        <li>
                            <div class="responsive-accordion-head"><?= $group ?></div>
                            <div class="responsive-accordion-panel">
                                <ul class="list">
                                    <?php foreach ($filters as $filter): ?>
                                        <li><a class="filter-item" data-filter-id="<?php echo $filter['id'] ?>"><?php echo $filter['title'] ?> <span>x</span></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="right_sidebar">
                <h4>It’s Our World-Resources for Missionary Discipleship</h4>
                <p>
	                The resources on this page are designed to supplement the digital experience provided by the Missio mobile app bringing you and those with whom you are connected &mdash; students, families, faith communities &mdash; to a greater awareness of the great needs of our world. Download our "featured" resources or use the filter function to access additional materials.
                </p>
                <div id="containerCN"></div><!-- // #containerCN -->
                <a class="resource-top is-visible">Top</a>
            </div><!-- // .right_sidebar -->
        </div>
    </div><!-- // .resource_sec -->
    ...
    <section class="app_download">
        <div class="wrapper">
            ...
            <a href="https://itunes.apple.com/us/app/missio/id606393585" class="apple_store" target="_blank"><img src="/images/app_store.png" alt=""></a> <a class="google_play" href="https://play.google.com/store/apps/details?id=com.littleiapps.missio" target="_blank"><img src="/images/google_play2.png" alt=""></a> </div>
    </section>
</section><!-- // .body_container -->
<div id="resource_template" class="hidden">
    <div class="col2 cols grid-item" id="{id}">
        <div class="inner">
            <div class="img-wrapper"><img alt="{title}" data-src="/resources/{image}" ></div>
            <div class="text">
                <span class="featured">Featured</span>
                <h3>{title}</h3>
                <p>{description}</p>
                <a href="/resources/{file}" target="_blank" class="download">Download PDF</a>
                <span class="txt filter_list" data-filters="{filters}"></span>
            </div>
        </div>
    </div>
</div>
