<section class="body_container">
    <div class="wrapper">
        <section class="donation_flow">
            ...
            <section class="list_sec" data-list="finance_donation_flow_us" data-id="us">
                <input name="page" id="page" type="hidden" value="1">
                <input name="order" id="order" type="hidden" value="state-asc">
                <h1>Donation Flow</h1>
                ...
                <section class="project_chart">
                    <table>
                        <thead>
                            <tr id="sorter">
                                <th><span id="state">State</span></span></th>
...
<table class="hidden">
    <tbody id="list_item_template">
        <tr>
            <td><a href="/dashboard/finance/donation-flow/us/{state_code}">{state}</a></td>
            <td><a href="/dashboard/finance/donation-flow/us/{state_code}" class="currency">${donated}</a></td>
            <td class="vertical-divider"><a href="/dashboard/finance/donation-flow/us/{state_code}" class="currency">{donated_donor}</a></td>
            <td><a href="/dashboard/finance/donation-flow/us/{state_code}" class="currency">${received}</a></td>
            <td><a href="/dashboard/finance/donation-flow/us/{state_code}" class="currency">{received_donor}</a></td>
        </tr>
    </tbody>
</table>